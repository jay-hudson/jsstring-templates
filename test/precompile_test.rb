...
class PrecompileTest < Minitest::Test
  ...
  def precompile!(rails_env)
    ...
    assert_match /object_name\.module\("templates", ?\[\]\)[,;]/, contents
    assert_match 'object_name.module("templates")', contents
  ...
  def test_precompile_succeeds_in_development_environment
    ...
    assert_match "jsstrings_templates.ignore_prefix: [\"ignored_namespace/\"]", contents
    assert_match "jsstrings_templates.markups:", contents
