...
describe "user assets integration" do
  ...
  describe "any rendered template" do
    ...
    it "has a comment with the gem name" do
      page.source.must_match   %r{// Js Strings Template}
    end
    ...
    it "opens an existing js string template" do
      page.source.must_include %Q{object_name.module("#{config.object_name}")}
    end
